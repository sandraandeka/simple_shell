#include "shell.h"
/**
 * execute - function that executes command
 * @command: The pointer to the tokienized comand
 * @name: The name of the shell
 * @env: the pointer to the environmetal variables
 ...
 * @env: The pointer to environmental variable
